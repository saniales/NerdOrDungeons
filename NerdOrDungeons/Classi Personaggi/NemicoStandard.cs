...
namespace NerdOrDungeons
{
    ...
    {               
        ...
        public static Nemico LittleDevil;     // 'V'
        public static Nemico Myself;       /* // '/' Me Stesso Inerme Quando All'Ultimo Livello Vengo Ucciso Da Me Stesso Cattivo Nella Mia Mente */
        ...
        static Nemico()
        {
            ...
            FightingPuppet  = new Nemico(MainGame.RiferimentoGlobaleAlGioco, Vector2.Zero, ParametriPersonaggio.Empty.Copy()          , DefaultPath + "FightingPuppet" , null                          , TipoIA.Assente, 0);
            Myself          = new Nemico(MainGame.RiferimentoGlobaleAlGioco, Vector2.Zero, ParametriPersonaggio.LinkBlue.Copy()       , DefaultPath + "Myself"         , null                          , TipoIA.Casuale, 0);
            ...
            EnemyShip       = new Nemico(MainGame.RiferimentoGlobaleAlGioco, Vector2.Zero, ParametriPersonaggio.EnemyShip.Copy()      , DefaultPath + "EnemyShip"      , Proiettile.Types["CannonBall"], TipoIA.Casuale, 0   );
            ...
            LittleDevil     = new Nemico(MainGame.RiferimentoGlobaleAlGioco, Vector2.Zero, ParametriPersonaggio.LittleDevil.Copy()    , DefaultPath + "LittleDevil"    , null                          , TipoIA.Insegui, 500 );
        }    
        ...
        {
            Nemico ret;
            ret = new Nemico(this, Posizione);
            /* APPLICO LA DIFFICOLTA (AUMENTO LA VITA DEI NEMICI) */
            ret.Parametri.Salute = (int)(this.Game.DifficultyMultiplier * this.Parametri.Salute);
            ret.Parametri.Attacco = (int)(this.Game.DifficultyMultiplier * this.Parametri.Attacco);
            ret.Parametri.Velocità = (this.Game.DifficultyMultiplier * this.Parametri.Velocità);

            return ret;
        }

        public Nemico Copy()
        { return Copy(this.posizione); }
